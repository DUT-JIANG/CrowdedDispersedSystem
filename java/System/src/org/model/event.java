...
public class event {
	...
	public event(String EventName, String EventType, String origin, String destination, String Crowd,
		...
		ret = Query.runSql(1, "Select max(event_id) from e_event");
		...
		String sql = "insert into e_event (event_id) values";
	...
	public event(int Event_id) {
		...
		String sql ="select * from e_event where event_id="+Integer.toString(Event_id);
