...
public class Evaluator{
	...
	public void run() {
		String sql = "select event_id,event_name,e_Status from e_event where event_id="+EventID;
		...
		sql = "insert into protection ";
		sql +="(attackerNum,defenderNum,Protection_result,Protection_score)";
