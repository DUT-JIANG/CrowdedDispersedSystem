    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            %>
                            <li>
                                <a class="active-menu" href="PersonalAreaServlet">个人主页</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
               ...
               <div class="row">
                <div class="col-md-6">
       			 <form action="PersonalModifyServlet?parm=<%=username%>" method="post">
                                  <table border="0" class="becenter">
                                                ...
                                                <tr>
                                                  ...
                                                  <th>姓名</th>
                                                  <th></th>
                                                  <th><input type="text" name="realname" value="<%=realname%>"></th>
                                                  <th></th>
                                                </tr>
                                                <tr>
                                                  <th></th>
                                                  <th>单位</th>
                                                  <th></th>
                                                  <th><input type="text" name="unit" value="<%=unit%>"></th>
                                                  <th></th>
                                                </tr>
                                                <tr>
                                                  <th></th>
                                                ...
                                                <tr>
                                                  ...
                                                  <th>身份证号</th>
                                                  <th></th>
                                                  <th><%=id%><input type="text" name="id" value="<%=tel%>" hidden="hidden"></th>
                                                  <th></th>
                                                </tr>
                                                <tr>
                                                  <th></th>
                                                  <th>出生年月日</th>
                                                  <th></th>
                                                  <th><%=birthdate%><input type="text" name="birthdate" value="<%=email%>" hidden="hidden"></th>
                                                  <th></th>
                                                  <th></th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <th></th>
                                                  <th></th>
                                                  <th><input type="submit" value="修改完成"></th>
                                                  <th></th>
                                                </tr>
                                                </table>
                                                <br>
