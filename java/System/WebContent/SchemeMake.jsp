	...
	%>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-md-12">
						<form action="SchemeMakeServlet" method="GET">
							<div class="panel-body becenter">
								<table border="0" class="becenter">
									<tr>
										...
										<th class="tr_input"><input autocomplete="off"
											type="text" class="form-control" name="EventName" value=""></th>
									</tr>
									<tr>
										<th></th>
										<th>事件类型</th>
										<th></th>
										<th><select class="form-control" name="EventType">
												<option>恐怖袭击</option>
												<option>火灾</option>
												<option>自然灾害</option>
										</select></th>
									...
									<tr>
										...
										<th>输入模式</th>
										<th></th>
										<th><select id="mode" onchange="selectOnchange()"
									...
									<tr>
										...
										<th>疏散点</th>
										<th></th>
										<th><input autocomplete="off" type="text"
											class="form-control" id="origin" name="origin" value=""
											title="地址（'xx市xx街道xx号'）或坐标（'40.321231,139.098765'）不含引号。经纬度最多支持小数点后六位"></th>
									</tr>
									<tr>
										<th></th>
										<th>避难点</th>
									...
									<tr>
										...
										<th></th>
										<th><input autocomplete="off" type="text"
											class="form-control" name="Crowd" value=""></th>
									</tr>
									<tr>
										<th></th>
										<th>录入人编号</th>
										<th></th>
										<th><input autocomplete="off" type="text"
											class="form-control" name="policeId" value=""></th>
									</tr>
									<tr>
										<th></th>
										<th>演练时间</th>
										<th></th>
										<th><input autocomplete="off" type="date"
											class="form-control" name="Time" value=""></th>
									</tr>
									<tr>
									...
									<tr>
										<th></th>
										<th><input autocomplete="off" type="button"
											class="btn btn-default botton1" value="清除内容"
											onclick="javascrtpt:window.location.href='SchemeMake.jsp'"></th>
										<th></th>
										<th><input autocomplete="off" type="submit"
											class="btn btn-default botton2" value="填写完成"></th>
									</tr>
								</table>
							</div>
						</form>
