...
<body>
	...
	%>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="Evaluator.jsp"><i class="fa fa-edit"></i> 演练评估 </a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            人群疏散方案评估<small>Evaluator</small>
                        </h1>
                    </div>
                </div> 
		...
		<%String isIniting = "1"; %>
	       	<div class="row">
	        	<div class="col-md-12">
				<form action="EvaluateServlet" method="GET">
                                        <div class="panel-body becenter">
                                            <table border="0" class="becenter">
                                                <tr>
                                                  ...
                                                  <th class="tr_input"><input autocomplete="off"type="text" class="form-control" name="EventName" value=""></th>
                                                </tr>
                                                                                                <tr>
                                                  <th></th>
                                                  <th>对应事件编号</th>
                                                  <th></th>
                                                  <th><input autocomplete="off"type="text" class="form-control" name="EventID" value=""></th>
                                                </tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <th>攻击人数</th>
                                                  <th></th>
                                                  <th><input autocomplete="off"type="text" class="form-control" name="AttackerNum" value=""></th>
                                                </tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <th>保护人数</th>
                                                  <th></th>
                                                  <th><input autocomplete="off"type="text" class="form-control" name="DefenderNum" value=""></th>
                                                </tr>
                                                                                                <tr>
                                                 <th></th>
                                                  <th>执行结果</th>
                                                  <th></th>
                                                  <th><textarea class="form-control" name="Result" value=""></textarea></th>
                                                </tr>		
                                                  ...
                                                  <th>分数</th>
                                                  <th></th>
                                                  <th><input autocomplete="off"type="text" class="form-control" name="Scores" value=""></th>
                                                </tr>
                                                ...
                                                <tr>
                                                  <th></th>
                                                  <th><input autocomplete="off"type="button" class="btn btn-default botton1"value="清除内容" onclick="javascrtpt:window.location.href='SchemeMake.jsp'"></th>
                                                  <th></th>
                                                  <th><input autocomplete="off"type="submit"class="btn btn-default botton2"  value="填写完成" ></th>
                                                </tr>
                                                </table>      
                                        </div>
                                        </form>     
